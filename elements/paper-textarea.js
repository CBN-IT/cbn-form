(function(CbnForm) {
	...
	Polymer.injectBehaviors('paper-textarea', [ CbnForm.DynamicElement,
		CbnForm.PaperContainer, CbnForm.PolymerElements.PaperTextareaExtension ]);
	
	CbnForm.registerElement('paper-textarea', {
			types: [ 'textarea' ],
			priority: 5
		});
