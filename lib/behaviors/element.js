(function(CbnForm) {
	...
	/**
	 * Defines the behavior that needs to be implemented by custom form elements.
	 * 
	...
	CbnForm.FormElement = {
		...
		properties: {
			...
			value: {
				type: String,
				value: '',
				notify: false, /** see {@link #_valueChanged} */
		...
		_setValue: function (value) {
			// let the _valueChanged observer handle notifications
			this.value = value;
		},
		 ...
		 * @protected
		 */
		_setIndirectValue: function(newValue, notification) {
			this._inputValueIndirectlyChanged = true;
			// the _valueChanged observer will synchronously fire and skip the `value-changed` event
			this._setValue(value);
			this._inputValueIndirectlyChanged = false;
			
			if (notification !== false) {
				if (!notification) notification = { indirect: true };
				this.fire('value-changed', Polymer.extend({
					value: newValue
				}, notification));
			}
		}
