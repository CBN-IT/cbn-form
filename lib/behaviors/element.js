(function(CbnForm) {
	 ...
	 * ancestor which implements the `FormContainer` interface and automatically sets the `parentForm` 
	...
	CbnForm.FormElement = {
		...
		properties: {
			 ...
			 * 
			 * Will be automatically when the element is attached to a form.
			 */
			parentForm: {
				type: Object,
				readOnly: true,
			 ...
			 * This will be overridden by the `CbnForm.InputElement` behavior.
			 */
			_hasModelValue: {
				type: Boolean,
				value: false
