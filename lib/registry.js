...
(function(CbnForm) {
	...
	Polymer.extend(CbnForm, {
		 ...
		 *                      (e.g.: 'input')
		 * @property {Boolean}  [hasModelValue] Whether the element contains a value for the form to submit. 
		 *                      Defaults to true. Set to Boolean false if this is just an inert form element.
		 */
