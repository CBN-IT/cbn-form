...
(function(CbnForm) {
	...
	CbnForm.Serialization = {
		...
		serializationModes: {
			 ...
			 *   see the `jsonArrays` option; if the array is empty, an empty value is appended;
			 ...
			 *   list, paired with their path along the model object; note: if an array is null, an empty value is
			 *   appended instead;
